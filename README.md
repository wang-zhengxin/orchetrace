...
- npm CLI 已进入四平台安装生命周期门禁，DMG/DEB/MSI 已有最终内容、运行时和签名检查；Developer ID/Windows 正式证书、macOS notarization、自动更新以及桌面/Homebrew 实体升级回滚验证尚未完成；
